    ...
    <main>
        ...
        <section class="content">
            <div class="text-panel">
                <h3>What does our company do?</h3>
        ...
        <section class="content">
            ...
            <div class="text-panel">
                <h3>Our Services</h3>
                <p>We offer property viewing, search capabilities, and detailed property information.</p>
            </div>
        </section>
        <section class="content">
            <div class="text-panel">
        ...
        <section class="content">
            ...
            <div class="text-panel">
                ...
                <p>We maintain competitive rates and exceptional customer service to keep our clients happy.</p>
            </div>
        </section>
    </main>
    <footer>
        <p>&copy; 2024 HomeMarket. All rights reserved.</p>
    </footer>
</body>
